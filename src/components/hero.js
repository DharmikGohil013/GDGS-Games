...
const featuredGames = [
  ...
  },
  {
    ...
    sub: 'Play Hextris Stack free online! Rotate the central hexagon, match 3 or more colored blocks, and build insane high-score combos.',
    eyebrow: '🔥 Trending Hot',
    bg: 'linear-gradient(155deg, #7C3AED, #4C1D95)',
    tag: 'Hextris Stack • 🔥 Trending Hot',
    category: 'puzzle',
    isPlayable: true,
    engine: 'canvas',
